...
function delete_transp_etrang(id,id_name){
    var id_notif = $("#"+id_name).val();
    $.ajax({
        url: '/api/deleteTransporteuretranger/'+id_notif+'/'+id,
        type: 'POST',
        data: {},
    })
        .done(function(data) {
...
function edit_transp_trang(id,id_name){
    var id_notif = $("#"+id_name).val();
    $.ajax({
        url: '/api/getoneTransporteuretranger/'+id+'/'+id_notif,
        type: 'POST',
        data: {},
    })
        .done(function(data) {
