            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <c:choose>
                    <c:when test="">
                      <input disabled class="form-control" value="${notification.autorite.nom_ar}" type="text">
                    </c:when>
                    <c:otherwise>
                      <input disabled class="form-control" value="${notification.autorite.nom_fr}" type="text">
                    </c:otherwise>
                  </c:choose>
                </div>
              </div>
