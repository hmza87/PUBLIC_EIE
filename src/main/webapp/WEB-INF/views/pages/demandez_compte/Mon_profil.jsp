                    ...
                    <form class="form-horizontal" id="registration" name="registration">
                        <div class="form-group" style="${pageContext.response.locale=='ar'?'text-align:right;':'text-align:left;'}">
                            <div class="row mt-4" >
                                    ...
                                    <input type="hidden" name="etat" id="etat" >
                                        ...
                                        <div class="col-md-6" >
                                            ...
                                            <div class="input-container">
                                                <input  dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}" disabled="disabled" type="text" name="numRc" value="${societe.st.numRc}" placeholder="<spring:message code="label.NumeroRC"/>" class="form-control"  onkeyup="ses_rc()"><p id="in_RC"></p>
                                                <div class="tooltip_" >
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <input required dir="rtl" type="text" name="raison_ar" placeholder="إسم الشركة " disabled="disabled" value="${societe.st.raison_ar}" class="form-control"  onkeyup="ses_ras()"><p id="in_Raison_Sociale"></p>
                                    </div>
                                    <div class="col-md-6">
                                        <input  required type="text" name="raison_fr" placeholder="Raison Sociale " disabled="disabled" value="${societe.st.raison_fr}" class="form-control"  onkeyup="ses_ras()"><p id="in_Raison_Sociale_fr"></p>
                                    </div>
                                </div>
                            <div class="row mt-4">
                                <div class="col-md-6">
                                <textarea dir="rtl" name="adresse_ar" placeholder="العنوان" class="form-control" disabled="disabled"  onkeyup="ses_ad()">${societe.st.adresse_ar}</textarea><p id="in_Adresse"></p>
                            </div>
                                <div class="col-md-6">
                                <textarea name="adresse_fr" placeholder="Adresse" class="form-control"  disabled="disabled" onkeyup="ses_ad()">${societe.st.adresse_fr}</textarea><p id="in_Adresse_fr"></p>
                            </div>
                            </div>
                            <div class="row mt-4">
                                  <div class="col-md-6">
                        ...
                        <div class="infor-supl" style="${pageContext.response.locale=='ar'?'text-align:right;':'text-align:left;'}">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" style="width: 350px;" for="ET_1"><spring:message code="label.Importationdesdechetsnondangereuxdunpaysetranger"/></label>
                                </div>
                            </div>
                                </div>
                            </div>
