                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12  ${dc.nom_ar=='oui'?'Doc_ok':'Doc_Not_ok'}">
                                                <div class="form-group">
                                                    ...
                                                    <a download
                                                       href="${url_Admin}${fn:replace(dc.url, "/assets/myFile/", "/dowload_uploaded/")}">
...
<a href="/api/checkUserHasCollecte/CT" class="btn kouidi " style="background-color: #7dc7bd;margin-bottom:12px;color:white;margin-top: 12px;">Enregistrer</a>
