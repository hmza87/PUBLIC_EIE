                        ...
                        <table id="tab2" class=" table table-striped hover compact table-bordered text-md-nowrap">
                            ...
                            <c:forEach items="${notif}" var="nt">
                                <tr>
                                    ...
                                    <td> <span class="badge badge-info"> ${(nt.statut.id_statut_projet==37 || nt.statut.id_statut_projet==54 || nt.statut.id_statut_projet==55 || nt.statut.id_statut_projet==71 || nt.statut.id_statut_projet==72 || nt.statut.id_statut_projet==48 || nt.statut.id_statut_projet==64 || nt.statut.id_statut_projet==65 || nt.statut.id_statut_projet==67 ||  nt.statut.id_statut_projet==68 || nt.statut.id_statut_projet==40)?nt.statut.nom_fr:"en cours de traitement" }</span>  </td>
                                    <td>  ${nt.operation }  </td>
